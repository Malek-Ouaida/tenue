...
def _raise_processing_error(err: ClosetProcessingError) -> None:
    http_status = {
        ...
        "original_image_empty": status.HTTP_400_BAD_REQUEST,
        ...
        "garment_provider_not_configured": status.HTTP_502_BAD_GATEWAY,
        "garment_provider_not_supported": status.HTTP_502_BAD_GATEWAY,
        "garment_provider_timeout": status.HTTP_502_BAD_GATEWAY,
        "garment_provider_unreachable": status.HTTP_502_BAD_GATEWAY,
        "garment_provider_failed": status.HTTP_502_BAD_GATEWAY,
        "garment_provider_invalid_response": status.HTTP_502_BAD_GATEWAY,
        "garment_analysis_invalid_response": status.HTTP_502_BAD_GATEWAY,
        "taxonomy_load_failed": status.HTTP_500_INTERNAL_SERVER_ERROR,
        "metadata_normalization_failed": status.HTTP_500_INTERNAL_SERVER_ERROR,
        "field_state_replace_failed": status.HTTP_500_INTERNAL_SERVER_ERROR,
        ...
        "processing_run_start_failed": status.HTTP_500_INTERNAL_SERVER_ERROR,
        "processing_run_success_update_failed": status.HTTP_500_INTERNAL_SERVER_ERROR,
        "processing_run_failure_update_failed": status.HTTP_500_INTERNAL_SERVER_ERROR,
    }.get(err.code, status.HTTP_400_BAD_REQUEST)
    raise HTTPException(status_code=http_status, detail={"error": err.code})
